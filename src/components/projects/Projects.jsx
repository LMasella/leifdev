  ...
  return (
    <div className="projects-container section">
      <div className="projects" id="projects">
          ...
          <Project comingSoon={true} image={asciibutton} title="The ASCII Button" description="The ASCII Button is a single page app with Bootstrap styling that utilizes AJAX and HTML Canvas/JavaScript to manipulate pixel data from an image URL, turning it into text. The back-end is set up using Python Flask." url="#projects" gitUrl="https://github.com/LMasella" />
      </div>
    </div>
  )
}
